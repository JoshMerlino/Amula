<html>
	...
	<body>
		...
		<div class="app-bar wi">
			<span class="app-info">Amula Apps - Upload</span>
			...
			<div class="card">
				...
				<div class="card-content">
					<div class="file-field">
						<div class="btn red waves-effect waves-light">
							<span>Apps</span>
							<input type="file" name="Apps" multiple accept="application/sla,application/vnd.ms-pki.stl,application/x-navistyle" required>
						</div>
						<div class="file-path-wrapper">
